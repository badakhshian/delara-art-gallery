...
export const pieces = [
  {
    ...
    images: ["/images/rueda-de-la-vida.jpg"],
    story:
      "Add the story behind this piece here — inspiration, process, what the title means to you. It will appear on the piece's detail page.",
    sold: false,
    isHero: true,
