...
export const pieces = [
  {
    id: "Wheel-of-Soaring",
    title: "wheel of Soaring",
    artist: "Delara Ahmadi Darani",
    year: "2026",
    medium: "Acrylic and modelling paste on canvas",
    dims: "48 × 48 in",
    priceCents:1120000, // e.g. 420000 for $4,200.00
    ///images: ["/images/IMG_6720.jpeg"], //rueda-de-la-vida.jpg
    images: ["/images/RuedaDeLaVida1.JPG","/images/RuedaDeLaVida2.jpg","/images/RuedaDeLaVida3.JPG","/images/RuedaDeLaVida4.JPG"],
    story:
  ...
  //-----------------------------
  {
    ...
    story:
      "This mixed-media painting explores abstraction through layered textures, organic patterns, and subtle color. Rather than depicting a single narrative, the composition invites viewers to experience rhythm, depth, and emotion through the interplay of form and surface.",
    sold: false,
    isHero: false,
  ...
  //-----------------------------
  {
    id: "Fragments-of-Silence",
    title: "Fragments of Silence",
    artist: "Delara Ahmadi Darani",
    year: "2024",
    medium: "Acrylic",
    dims:  "3 pcs of 24x36 in",
    priceCents: 740000,
    images: ["/images/Fragments-of-Silence1.jpg"],
    story:
      "fluid linework creates an abstract landscape that feels both dynamic and contemplative. The triptych invites the viewer to explore movement, atmosphere, and the quiet tension between structure and spontaneity.",
    sold: false,
    isHero: false,
